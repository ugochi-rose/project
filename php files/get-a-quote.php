                    ...
                    <div class="container img-text px-5 text-center ">
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-12">
                                <!-- breadcrumb -->
                                <div class="fade-in">
                                    <h4 class="fw-bold" style="font-size: 3rem;">Contact Us</h4>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row text-center justify-content-center py-4">
                    <div class="col-lg-7 col-md-5 text-center">
                        <p class="lh-sm">Connect with Us</p>
                        <p class="lh-sm"> We are excited to hear from you</p>
                    </div>
                </div>

                <div class="row gx-4 mx-auto justify-content-center pt-md-5 pt-4 pb-5">
                    <div class="col-md-12 col-lg-7">
                        <div class="form-bg p-lg-5 py-5 px-4 me-lg-4 shadow" style="background-color: white; border-radius: 5px; border-bottom: 3px solid #66b4b1;">
                            <form action="includes/contact.inc.php" method="POST" class="needs-validation" novalidate>
                                <h4 class="pb-3" style="font-weight: 600; color:#66b4b1" >Get in Touch with Us</h4>
                                <div class="row mb-3">
                                    <div class="col-md-6 mb-md-3">
                                        <!-- Access key for form to email submittion -->
                                        <!-- <input type="hidden" name="access_key" value="b5d85b7c-d36c-4956-8ee1-570b937821fd"> -->
                                        <input type="text" name="contact_name" class="form-control" id="firstName" placeholder="Name" required>
                                        <div class="invalid-feedback">
                                            Please provide your name.
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <input type="email" name="contact_email" class="form-control mt-3 mt-md-0" id="email" placeholder="Email" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <textarea name="contact_message" class="form-control form-control mb-3" id="" cols="30" rows="10" placeholder="Message" required></textarea>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row mb-4 justify-content-end">
                                        <div class="col-12">
                                            <button type="submit" name="submit" class="btn-body career-btn btn btn-primary px-5 py-2" style="border-radius: 5px!important; background-color:#66b4b1 !important"; data-bs-toggle="modal">Submit</button>
                                        </div>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-5 ps-lg-5 ps-0 pt-5 col-10">
                        <h4 style="font-weight: 600; color: #66b4b1">Contact Details</h4>
                        <div class="row">
                            <div class="col-lg-10 col-md-12">
                                <p class="mt-2" style="font-size: 14.4px;">We will love to hear from you! Contact us today if you have questions, dicuss your goals, get a quote or learn more about our services. </p>
                            </div>
                        </div>
                        
                        <div class="row">
                            <div class="col-lg-9 col-12 pt-lg-2">
                                <div class="d-flex align-items-start mb-2">
                                    <!-- Icon (kept outside the grouped container) -->
                                    <i class="bi bi-geo-alt-fill me-1" style="font-size: 1.2rem; color: #66b4b1 !important; 
                                    padding-top: 0.8rem !important"></i>
                                    <!-- Grouped Content -->
                                    <div class="d-flex flex-column p-3">
                                        <!-- Location Title -->
                                        <h6 class="m-0" style="font-weight: 600;">Locations</h6>
                                        <!-- Address 1 -->
                                        <div class="text-wrap pt-2" style="font-size: 14.4px;">
                                            <span>Plot 24, Road 5, Off Ada George/Location Road Port Harcourt</span>
                                        </div>
                                        <!-- Address 2 -->
                                        <div class="text-wrap pt-3" style="font-size: 14.4px;">
                                            <span>186 Westorn Road Grangemouth FK3 9EZ, United Kingdom</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-9 col-12">
                                <div class="d-flex align-items-start">
                                    <!-- Icon -->
                                    <i class="bi bi-envelope-fill me-2" style="font-size: 1.2rem; color: #66b4b1 !important;  
                                    padding-top: 0.8rem !important"></i>
                                    <!-- Grouped Content -->
                                    <div class="d-flex flex-column p-3">
                                        <!-- Title -->
                                        <h6 class="m-0" style="font-weight: 600;">Email Us</h6>
                                        <!-- Email -->
                                        <div class="text-wrap pt-2" style="font-size: 14.4px;">
                                            <span>info@kemof-ng.com</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-12">
                                <div class="d-flex align-items-start">
                                    <!-- Icon -->
                                    <i class="bi bi-telephone-fill me-2" style="font-size: 1.2rem; color: #66b4b1 !important;   
                                    padding-top: 0.8rem !important"></i>
                                    <!-- Grouped Content -->
                                    <div class="d-flex flex-column p-3">
                                        <!-- Title -->
                                        <h6 class="m-0" style="font-weight: 600;">Phone</h6>
                                        <!-- Phone Number -->
                                        <div class="text-wrap pt-2" style="font-size: 14.4px;">
                                            <span>+447534447673</span><BR>
                                            <span>(+234) 7032130104</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered container">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="fs-4" style="font-weight: 600;">Thank you for reaching out!</p>
